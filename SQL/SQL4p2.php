...
<div class="container my-5">
    <h2>  The top 10 albums per year based on their number of sales (2022) </h2>
    <br>
    <a class='btn btn-primary btn-sm' href="/EliteExam/index.php">Home</a>
    <a class='btn btn-secondary btn-sm' href="/EliteExam/SQL4p1.php">2021</a>
    <table class="table">
        <thead>
            <tr>
                <th>Artist</th>
